...
sudo wget -q -O /opt/lightgun-dashboard/index.html \
...
sudo wget -q -O /opt/lightgun-dashboard/manifest.json \
...
sudo wget -q -O /opt/lightgun-dashboard/ps1_games.json \
